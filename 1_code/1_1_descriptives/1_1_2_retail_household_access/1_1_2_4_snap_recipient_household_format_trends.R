#///////////////////////////////////////////////////////////////////////////////
#----                              Preamble                                 ----
# File name:        1_1_2_4_snap_recipient_household_format_trends.R
# Previous author:  -
# Current author:   Codex
# Last Updated:     May 27, 2026
# Description:      Compare the SNAP-recipient-household weighted nearest
#                   distance metric over time, with one line per retailer
#                   format.
# INPUTS:           `2_10_retail_access/2_10_2_county_retail_access_weighted_summary.rds`
# OUTPUTS:          `3_outputs/3_1_descriptives/3_1_2_retail_access/3_1_2_4_snap_recipient_household_format_trends.csv`
#                   `3_outputs/3_1_descriptives/3_1_2_retail_access/3_1_2_4_snap_recipient_household_format_trends.jpeg`
#///////////////////////////////////////////////////////////////////////////////
...
snap_format_trend <- ctx$county_summary |>
...
readr::write_csv(
  snap_format_trend,
  retail_access_output_path("3_1_2_4_snap_recipient_household_format_trends.csv")
)
...
p <- ggplot(
  ...
  labs(
    title = "SNAP-Weighted Nearest Distance by Retailer Format",
...
ggsave(
  filename = retail_access_output_path("3_1_2_4_snap_recipient_household_format_trends.jpeg"),
  plot = p,
  width = 9,
  height = 6,
  units = "in"
