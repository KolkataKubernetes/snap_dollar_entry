#///////////////////////////////////////////////////////////////////////////////
#----                              Preamble                                 ----
# File name:        1_1_5_snap_retailer_composition.R
# Previous author:  -
...
composition_data <- ctx$format_stock |>
  ...
  ungroup() |>
  mutate(
    total_stock_label = format(total_stock, big.mark = ",", trim = TRUE),
...
p <- ggplot(
  ...
  labs(
    ...
    subtitle = "Retailer stock shares across benchmark format groups, 2010 vs 2019",
    x = NULL,
