...
# OUTPUTS:          `3_outputs/3_2_reduced_form/3_2_0_county/3_2_0_1c_stockregs/3_2_11_event_study_ihs_all_stock_table*.png`
#                   `3_outputs/3_2_reduced_form/3_2_0_county/3_2_0_1c_stockregs/3_2_11_event_study_ihs_all_stock_table*.jpeg`
#                   `3_outputs/3_0_tables/3_2_0_county/3_2_0_1c_stockregs/3_2_11_event_study_ihs_all_stock_table*.csv`
...
png_path <- reduced_form_plot_path("3_2_11_event_study_ihs_all_stock_table.png")
jpeg_path <- reduced_form_plot_path("3_2_11_event_study_ihs_all_stock_table.jpeg")
csv_path <- reduced_form_table_path("3_2_11_event_study_ihs_all_stock_table.csv")
