#///////////////////////////////////////////////////////////////////////////////
#----                              Preamble                                 ----
# File name:        1_2_0_2_0_build_event_study_sample.R
# Description:      Build the county event-study sample for total-population
#                   weighted average distance outcomes.
# INPUTS:           `2_9_analysis/2_9_0_us_analysis_panel.rds`
#                   `2_10_retail_access/2_10_2_county_retail_access_weighted_summary.rds`
#                   `2_processed_data/processed_root.txt`
# OUTPUTS:          `2_10_retail_access/2_10_4_event_study_sample_distance_totalpop.rds`
#///////////////////////////////////////////////////////////////////////////////
...
county_distance <- readRDS(
  ...
  pivot_wider(
    names_from = outcome,
    values_from = county_weighted_distance_miles
  )
...
saveRDS(
  aba1,
  file.path(processed_root, "2_10_retail_access", "2_10_4_event_study_sample_distance_totalpop.rds")
)
