...
# Description:      Shared helper functions for the county distance reduced-form
#                   scripts using total-population weighted average distance
#                   outcomes.
# INPUTS:           `2_processed_data/processed_root.txt`
#                   `2_10_retail_access/2_10_4_event_study_sample_distance_totalpop.rds`
# OUTPUTS:          No direct outputs. Downstream scripts use these helpers to
#                   write versioned `.pdf` and `.tex` artifacts under
#                   `3_outputs`.
# DEPENDENCIES:     `fixest`, `ggplot2`, parent reduced-form helpers
#///////////////////////////////////////////////////////////////////////////////
...
source(file.path(dirname(script_dir), "1_2_0_1_regs", "shared_reduced_form_helpers.R"))

distance_sample_filename <- "2_10_4_event_study_sample_distance_totalpop.rds"
