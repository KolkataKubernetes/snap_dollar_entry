...
#///////////////////////////////////////////////////////////////////////////////
#----                              Preamble                                 ----
# File name:        1_2_0_2_10_event_study_distance_dollar_stores_urban_rural_het.R
# Description:      Metro versus non-metro heterogeneity Sun-Abraham event
#                   study for total-population-weighted dollar-store distance.
# INPUTS:           `2_10_retail_access/2_10_4_event_study_sample_distance_totalpop.rds`
#                   `0_inputs/input_root.txt`
#                   `0_7_Ruralurbancontinuumcodes2013.xls`
# OUTPUTS:          `3_outputs/3_2_reduced_form/3_2_0_county/3_2_0_2_distance_totalpop_regs/3_2_0_2_10_event_study_distance_dollar_stores_urban_rural_het.pdf`
#                   `3_outputs/3_0_tables/3_2_0_county/3_2_0_2_distance_totalpop_regs/3_2_0_2_10_event_study_distance_dollar_stores_urban_rural_het.tex`
...
event_plot <- ggplot(
  ...
  labs(
    ...
    subtitle = "Total-population-weighted outcome",
    x = "Event time",
    y = "Coefficient"
  ) +
  theme_im(base_size = 12)

plot_path <- reduced_form_plot_path("3_2_0_2_10_event_study_distance_dollar_stores_urban_rural_het.pdf")
table_path <- reduced_form_table_path("3_2_0_2_10_event_study_distance_dollar_stores_urban_rural_het.tex")
