#///////////////////////////////////////////////////////////////////////////////
#----                              Preamble                                 ----
# File name:        1_2_0_2_4_event_study_chain_multi_category_poissonreg.R
# Description:      Thin wrapper that runs the county stock-Poisson ETWFE reduced
#                   form for multi-category stock using the shared helper
#                   script.
# INPUTS:           `2_9_analysis/2_9_5_county_stockpoissonreg_sample.rds`
#                   `2_processed_data/processed_root.txt`
# OUTPUTS:          versioned plot/table/csv artifacts for the multi-category
...
#                   correspond to Multi-category stock.
#///////////////////////////////////////////////////////////////////////////////
...
save_event_study_artifact("chain_multi_category_stock", "Multi Category Stock", "3_2_0_2_4_event_study_chain_multi_category_stockpoissonreg")
