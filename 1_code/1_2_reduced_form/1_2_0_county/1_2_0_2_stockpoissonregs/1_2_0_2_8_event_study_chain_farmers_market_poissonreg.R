#///////////////////////////////////////////////////////////////////////////////
#----                              Preamble                                 ----
# File name:        1_2_0_2_8_event_study_chain_farmers_market_poissonreg.R
# Description:      Thin wrapper that runs the county stock-Poisson ETWFE reduced
#                   form for farmers-market stock using the shared helper
#                   script.
# INPUTS:           `2_9_analysis/2_9_5_county_stockpoissonreg_sample.rds`
#                   `2_processed_data/processed_root.txt`
# OUTPUTS:          versioned plot/table/csv artifacts for the farmers-market
...
#                   correspond to Farmers-market stock.
#///////////////////////////////////////////////////////////////////////////////
...
save_event_study_artifact("chain_farmers_market_stock", "Farmers Market Stock", "3_2_0_2_8_event_study_chain_farmers_market_stockpoissonreg")
