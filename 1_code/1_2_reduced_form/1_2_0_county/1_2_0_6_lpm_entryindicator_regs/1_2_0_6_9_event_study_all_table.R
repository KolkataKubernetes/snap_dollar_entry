#///////////////////////////////////////////////////////////////////////////////
#----                              Preamble                                 ----
# File name:        1_2_0_6_9_event_study_all_table.R
# Description:      Estimate the county LPM entry-indicator reduced form for
#                   every outlet outcome and export a combined ATT table.
# INPUTS:           `2_9_analysis/2_9_9_event_study_sample_lpm_entryindicator.rds`
#                   `2_processed_data/processed_root.txt`
# OUTPUTS:          `3_outputs/3_0_tables/3_2_0_county/3_2_0_6_lpm_entryindicator_regs/3_2_0_6_9_event_study_lpm_all_entry*.tex`
...
etable(
  models$total_ds_entry,
  models$chain_super_market_entry,
  models$chain_convenience_store_entry,
  models$chain_multi_category_entry,
  models$chain_medium_grocery_entry,
  models$chain_small_grocery_entry,
  models$chain_produce_entry,
  models$chain_farmers_market_entry,
  headers = unname(event_study_labels),
  file = reduced_form_table_path("3_2_0_6_9_event_study_lpm_all_entry.tex"),
  agg = "att",
  keep = "ATT",
  replace = TRUE
)
