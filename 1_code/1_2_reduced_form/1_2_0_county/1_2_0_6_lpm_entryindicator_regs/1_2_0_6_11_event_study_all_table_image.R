#///////////////////////////////////////////////////////////////////////////////
#----                              Preamble                                 ----
# File name:        1_2_0_6_11_event_study_all_table_image.R
# Description:      Estimate the county LPM entry-indicator reduced form for
#                   every outlet outcome and render a slide-ready image table
#                   of ATT and fit statistics.
# INPUTS:           `2_9_analysis/2_9_9_event_study_sample_lpm_entryindicator.rds`
#                   `2_processed_data/processed_root.txt`
# OUTPUTS:          `3_outputs/3_2_reduced_form/3_2_0_county/3_2_0_6_lpm_entryindicator_regs/3_2_0_6_11_event_study_lpm_all_entry_table*.png`
#                   `3_outputs/3_2_reduced_form/3_2_0_county/3_2_0_6_lpm_entryindicator_regs/3_2_0_6_11_event_study_lpm_all_entry_table*.jpeg`
#                   `3_outputs/3_0_tables/3_2_0_county/3_2_0_6_lpm_entryindicator_regs/3_2_0_6_11_event_study_lpm_all_entry_table*.csv`
...
#                   with `1_2_0_6_9_event_study_all_table.R`.
#///////////////////////////////////////////////////////////////////////////////
...
footnote_grob <- textGrob(
  "Outcome is an outlet-specific annual entry indicator; clustered (county_fips) standard-errors in parentheses\nSignif. Codes: ***: 0.01, **: 0.05, *: 0.1",
  x = unit(0, "npc"),
  hjust = 0,
...
png_path <- reduced_form_plot_path("3_2_0_6_11_event_study_lpm_all_entry_table.png")
jpeg_path <- reduced_form_plot_path("3_2_0_6_11_event_study_lpm_all_entry_table.jpeg")
csv_path <- reduced_form_table_path("3_2_0_6_11_event_study_lpm_all_entry_table.csv")
