#///////////////////////////////////////////////////////////////////////////////
#----                              Preamble                                 ----
# File name:        1_2_0_6_4_event_study_chain_multi_category.R
# Description:      Thin wrapper that runs the county LPM entry-indicator reduced form for
#                   multi-category chains using the shared helper script.
# INPUTS:           `2_9_analysis/2_9_9_event_study_sample_lpm_entryindicator.rds`
#                   `2_processed_data/processed_root.txt`
# OUTPUTS:          `3_outputs/3_2_reduced_form/3_2_0_county/3_2_0_6_lpm_entryindicator_regs/3_2_0_6_4_event_study_lpm_chain_multi_category_entry*.pdf`
#                   `3_outputs/3_0_tables/3_2_0_county/3_2_0_6_lpm_entryindicator_regs/3_2_0_6_4_event_study_lpm_chain_multi_category_entry*.tex`
...
# Delegate the entry-indicator event study to the helper for the multi-category outcome.
save_event_study_artifact("chain_multi_category_entry", "Multi Category", "3_2_0_6_4_event_study_lpm_chain_multi_category_entry")
