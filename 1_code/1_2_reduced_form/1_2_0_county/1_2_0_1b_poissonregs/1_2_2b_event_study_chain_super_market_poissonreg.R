...
#                   form for Supermarkets using the shared helper script.
...
save_event_study_artifact("chain_super_market", "Supermarkets", "3_2_2b_event_study_ihs_chain_super_market_poissonreg")
