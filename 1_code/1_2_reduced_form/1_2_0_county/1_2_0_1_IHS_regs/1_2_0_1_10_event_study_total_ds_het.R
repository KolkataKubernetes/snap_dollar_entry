...
#///////////////////////////////////////////////////////////////////////////////
#----                              Preamble                                 ----
# File name:        1_2_0_1_10_event_study_total_ds_het.R
# Previous author:  -
...
#                   helper scripts.
# OUTPUTS:          `3_outputs/3_2_reduced_form/3_2_0_county/3_2_0_1_IHS_regs/3_2_0_1_10_event_study_ihs_total_ds_het*.pdf`
#                   `3_outputs/3_0_tables/3_2_0_county/3_2_0_1_IHS_regs/3_2_0_1_10_event_study_ihs_total_ds_het*.tex`
#                   `3_outputs/3_2_reduced_form/3_2_0_county/3_2_0_1_IHS_regs/3_2_0_1_10_event_study_ihs_total_ds_het_metro_nonmetro*.pdf`
#                   `3_outputs/3_0_tables/3_2_0_county/3_2_0_1_IHS_regs/3_2_0_1_10_event_study_ihs_total_ds_het_metro_nonmetro*.tex`
...
ensure_output_dirs <- function() {
  plot_dir <- file.path("3_outputs", "3_2_reduced_form", "3_2_0_county", "3_2_0_1_IHS_regs")
  table_dir <- file.path("3_outputs", "3_0_tables", "3_2_0_county", "3_2_0_1_IHS_regs")
...
plot_path_three <- next_available_path(
  file.path(output_dirs$plot_dir, "3_2_0_1_10_event_study_ihs_total_ds_het.pdf")
)
table_path_three <- next_available_path(
  file.path(output_dirs$table_dir, "3_2_0_1_10_event_study_ihs_total_ds_het.tex")
)

plot_path_two <- next_available_path(
  file.path(output_dirs$plot_dir, "3_2_0_1_10_event_study_ihs_total_ds_het_metro_nonmetro.pdf")
)
table_path_two <- next_available_path(
  file.path(output_dirs$table_dir, "3_2_0_1_10_event_study_ihs_total_ds_het_metro_nonmetro.tex")
)
