...
# Description:      Shared helper functions for the county stock-regression
#                   branch. These helpers resolve paths, load the branch-
#                   specific county stock sample, estimate the benchmark
#                   Sun-Abraham specification on stock outcomes, and write
#                   versioned figure/table outputs under `3_outputs`.
# INPUTS:           `2_processed_data/processed_root.txt`
#                   `2_9_analysis/2_9_4_county_stockreg_sample.rds`
...
# Review focus:     Verify that the branch-specific sample path is correct,
#                   that the benchmark model formula is unchanged aside from
#                   using stock outcomes, and that output names remain
#                   versioned rather than overwriting prior artifacts.
#///////////////////////////////////////////////////////////////////////////////
...
load_event_study_sample <- function() {
  ...
  readRDS(file.path(processed_root, "2_9_analysis", "2_9_4_county_stockreg_sample.rds"))
}
