#///////////////////////////////////////////////////////////////////////////////
#----                              Preamble                                 ----
# File name:        1_2_0_3_2_event_study_chain_super_market.R
# Description:      Thin wrapper that runs the county stock-regression branch
#                   for supermarket stock using the shared helper script.
# INPUTS:           `2_9_analysis/2_9_4_county_stockreg_sample.rds`
#                   `2_processed_data/processed_root.txt`
# OUTPUTS:          `3_outputs/3_2_reduced_form/3_2_0_county/3_2_0_3_stockregs/3_2_0_3_2_event_study_ihs_chain_super_market_stock*.pdf`
#                   `3_outputs/3_0_tables/3_2_0_county/3_2_0_3_stockregs/3_2_0_3_2_event_study_ihs_chain_super_market_stock*.tex`
...
# Delegate the benchmark event study to the helper for the supermarket stock outcome.
save_event_study_artifact("chain_super_market_stock", "Supermarket Stock", "3_2_0_3_2_event_study_ihs_chain_super_market_stock")
