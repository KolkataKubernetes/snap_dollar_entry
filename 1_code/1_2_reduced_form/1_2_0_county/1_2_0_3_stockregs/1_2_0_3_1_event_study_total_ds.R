#///////////////////////////////////////////////////////////////////////////////
#----                              Preamble                                 ----
# File name:        1_2_0_3_1_event_study_total_ds.R
# Description:      Thin wrapper that runs the county stock-regression branch
#                   for Dollar Store stock using the shared helper script.
# INPUTS:           `2_9_analysis/2_9_4_county_stockreg_sample.rds`
#                   `2_processed_data/processed_root.txt`
# OUTPUTS:          `3_outputs/3_2_reduced_form/3_2_0_county/3_2_0_3_stockregs/3_2_0_3_1_event_study_ihs_total_ds_stock*.pdf`
#                   `3_outputs/3_0_tables/3_2_0_county/3_2_0_3_stockregs/3_2_0_3_1_event_study_ihs_total_ds_stock*.tex`
...
# Delegate the benchmark event study to the helper using the Dollar Store
# stock outcome column and the matching output stub.
save_event_study_artifact("total_ds_stock", "Dollar Store Stock", "3_2_0_3_1_event_study_ihs_total_ds_stock")
